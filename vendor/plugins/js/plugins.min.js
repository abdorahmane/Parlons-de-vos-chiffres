( (t, e) => {
    ...
    function Q(t, e, i) {
        var n, o, r = (i = i || C).createElement("script");
        if (r.text = t,
        e)
            for (n in U)
    ...
    function Y(t) {
        return null == t ? t + "" : "object" == typeof t || "function" == typeof t ? F[W.call(t)] || "object" : typeof t
    }
    var t = "3.7.1"
      , X = /HTML$/i
      , T = function(t, e) {
    ...
    T.extend = T.fn.extend = function() {
        var t, e, i, n, o, r = arguments[0] || {}, s = 1, a = arguments.length, l = !1;
        ...
        s--); s < a; s++)
            if (null != (t = arguments[s]))
                for (e in t)
                    i = t[e],
                    "__proto__" !== e && r !== i && (l && i && (T.isPlainObject(i) || (n = Array.isArray(i))) ? (o = r[e],
                    o = n && !Array.isArray(o) ? [] : n || T.isPlainObject(o) ? o : {},
                    n = !1,
                    r[e] = T.extend(l, o, i)) : void 0 !== i && (r[e] = i));
        return r
    }
    ,
    T.extend({
        ...
        makeArray: function(t, e) {
            e = e || [];
            return null != t && (G(Object(t)) ? T.merge(e, "string" == typeof t ? [t] : t) : H.call(e, t)),
            e
        },
    ...
    ;
    var nt, w, ot, rt, st, E, n, S, d, at, o = C, lt = H, k = lt, I = T.expando, A = 0, ct = 0, ut = At(), ht = At(), dt = At(), pt = At(), ft = function(t, e) {
        return t === e && (st = !0),
        0
    }, mt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", t = "(?:\\\\[\\da-fA-F]{1,6}" + i + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", r = "\\[" + i + "*(" + t + ")(?:" + i + "*([*^$|!~]?=)" + i + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + t + "))|)" + i + "*\\]", s = ":(" + t + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + r + ")*)|.*)\\)|)", gt = new RegExp(i + "+","g"), vt = new RegExp("^" + i + "*," + i + "*"), yt = new RegExp("^" + i + "*([>+~]|" + i + ")" + i + "*"), bt = new RegExp(i + "|>"), _t = new RegExp(s), wt = new RegExp("^" + t + "$"), xt = {
        ID: new RegExp("^#(" + t + ")"),
        CLASS: new RegExp("^\\.(" + t + ")"),
        TAG: new RegExp("^(" + t + "|[*])"),
        ATTR: new RegExp("^" + r),
    ...
    }, Ct = /^(?:input|select|textarea|button)$/i, Tt = /^h\d$/i, Et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, St = /[+~]/, h = new RegExp("\\\\[\\da-fA-F]{1,6}" + i + "?|\\\\([^\\r\\n\\f])","g"), p = function(t, e) {
    ...
    function O(t, e, i, n) {
        var o, r, s, a, l, c, u = e && e.ownerDocument, h = e ? e.nodeType : 9;
        if (i = i || [],
        ...
        S)) {
            ...
            if (!(pt[t + " "] || d && d.test(t))) {
                if (c = t,
                u = e,
                1 === h && (bt.test(t) || yt.test(t))) {
                    for ((u = St.test(t) && Pt(e.parentNode) || e) == e && m.scope || ((s = e.getAttribute("id")) ? s = T.escapeSelector(s) : e.setAttribute("id", s = I)),
                    r = (l = zt(t)).length; r--; )
                        l[r] = (s ? "#" + s : ":scope") + " " + Rt(l[r]);
                    c = l.join(",")
                }
                try {
                    return k.apply(i, u.querySelectorAll(c)),
                    i
                } catch (e) {
                    pt(t, !0)
                } finally {
    ...
    function jt(t) {
        ...
        return t != E && 9 === t.nodeType && t.documentElement && (n = (E = t).documentElement,
        S = !T.isXMLDoc(E),
        at = n.matches || n.webkitMatchesSelector || n.msMatchesSelector,
        n.msMatchesSelector && o != E && (t = E.defaultView) && t.top !== t && t.addEventListener("unload", kt),
        m.getById = Ot(function(t) {
            return n.appendChild(t).id = T.expando,
        ...
        Ot(function(t) {
            var e;
            n.appendChild(t).innerHTML = "<a id='" + I + "' href='' disabled='disabled'></a><select id='" + I + "-\r\\' disabled='disabled'><option selected=''></option></select>",
            t.querySelectorAll("[selected]").length || d.push("\\[" + i + "*(?:value|" + mt + ")"),
            t.querySelectorAll("[id~=" + I + "-]").length || d.push("~="),
            t.querySelectorAll("a#" + I + "+*").length || d.push(".#.+[+~]"),
        ...
        ft = function(t, e) {
            var i;
            return t === e ? (st = !0,
            0) : !t.compareDocumentPosition - !e.compareDocumentPosition || (1 & (i = (t.ownerDocument || t) == (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !m.sortDetached && e.compareDocumentPosition(t) === i ? t === E || t.ownerDocument == o && O.contains(o, t) ? -1 : e === E || e.ownerDocument == o && O.contains(o, e) ? 1 : rt ? _.call(rt, t) - _.call(rt, e) : 0 : 4 & i ? -1 : 1)
        }
        ),
        E
    }
    ...
    (w = T.expr = {
        ...
        preFilter: {
            ...
            PSEUDO: function(t) {
                var e, i = !t[6] && t[2];
                return xt.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && _t.test(i) && (e = (e = zt(i, !0)) && i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                t[2] = i.slice(0, e)),
                t.slice(0, 3))
            }
        },
        filter: {
            ...
            ATTR: function(e, i, n) {
                return function(t) {
                    t = O.attr(t, e);
                    return null == t ? "!=" === i : !i || (t += "",
                    "=" === i ? t === n : "!=" === i ? t !== n : "^=" === i ? n && 0 === t.indexOf(n) : "*=" === i ? n && -1 < t.indexOf(n) : "$=" === i ? n && t.slice(-n.length) === n : "~=" === i ? -1 < (" " + t.replace(gt, " ") + " ").indexOf(n) : "|=" === i && (t === n || t.slice(0, n.length + 1) === n + "-"))
                }
            },
            CHILD: function(p, t, e, f, m) {
                ...
                : function(t, e, i) {
                    var n, o, r, s, a, l = g != v ? "nextSibling" : "previousSibling", c = t.parentNode, u = y && t.nodeName.toLowerCase(), h = !i && !y, d = !1;
                    if (c) {
                        if (g) {
                            for (; l; ) {
                                for (r = t; r = r[l]; )
                                    if (y ? b(r, u) : 1 === r.nodeType)
                                        return !1;
                        ...
                        v && h) {
                            for (d = (s = (n = (o = c[I] || (c[I] = {}))[p] || [])[0] === A && n[1]) && n[2],
                            r = s && c.childNodes[s]; r = ++s && r && r[l] || (d = s = 0,
                            a.pop()); )
                                if (1 === r.nodeType && ++d && r === t) {
                                    o[p] = [A, s, d];
                                    break
                                }
                        } else if (!1 === (d = h ? s = (n = (o = t[I] || (t[I] = {}))[p] || [])[0] === A && n[1] : d))
                            for (; (r = ++s && r && r[l] || (d = s = 0,
                            a.pop())) && ((y ? !b(r, u) : 1 !== r.nodeType) || !++d || (h && ((o = r[I] || (r[I] = {}))[p] = [A, d]),
                            r !== t)); )
                                ;
            ...
            PSEUDO: function(t, r) {
                var e, s = w.pseudos[t] || w.setFilters[t.toLowerCase()] || O.error("unsupported pseudo: " + t);
                return s[I] ? s(r) : 1 < s.length ? (e = [t, t, "", r],
        ...
        pseudos: {
            ...
            lang: l(function(i) {
                return wt.test(i || "") || O.error("unsupported lang: " + i),
    ...
    function Mt() {}
    function zt(t, e) {
        var i, n, o, r, s, a, l, c = ht[t + " "];
        if (c)
            return e ? 0 : c.slice(0);
        for (s = t,
        a = [],
        l = w.preFilter; s; ) {
            for (r in i && !(n = vt.exec(s)) || (n && (s = s.slice(n[0].length) || s),
            a.push(o = [])),
            i = !1,
            (n = yt.exec(s)) && (i = n.shift(),
            o.push({
                value: i,
                type: n[0].replace(tt, " ")
            }),
            s = s.slice(i.length)),
            w.filter)
                !(n = xt[r].exec(s)) || l[r] && !(n = l[r](n)) || (i = n.shift(),
                o.push({
                    value: i,
                    type: r,
                    matches: n
    ...
    function Ft(p, f, m, g, v, t) {
        return g && !g[I] && (g = Ft(g)),
        v && !v[I] && (v = Ft(v, t)),
        l(function(t, e, i, n) {
            var o, r, s, a, l = [], c = [], u = e.length, h = t || ( (t, e, i) => {
            ...
            if (t) {
                if (v || p) {
                    ...
                    for (r = a.length; r--; )
                        (s = a[r]) && -1 < (o = v ? _.call(t, s) : l[r]) && (t[o] = !(e[o] = s))
                }
            } else
                a = Ht(a === e ? a.splice(u, a.length) : a),
                v ? v(null, e, a, n) : k.apply(e, a)
        })
    }
    function Wt(t, e) {
        var i, g, v, y, b, n, o = [], r = [], s = dt[t + " "];
        if (!s) {
            for (i = (e = e || zt(t)).length; i--; )
                ((s = function t(e) {
                    for (var n, i, o, r = e.length, s = w.relative[e[0].type], a = s || w.relative[" "], l = s ? 1 : 0, c = Nt(function(t) {
                        return t === n
                    }, a, !0), u = Nt(function(t) {
                        return -1 < _.call(n, t)
                    }, a, !0), h = [function(t, e, i) {
                        return t = !s && (i || e != ot) || ((n = e).nodeType ? c : u)(t, e, i),
                        n = null,
                        t
                    }
                    ]; l < r; l++)
                        if (i = w.relative[e[l].type])
                            ...
                            if ((i = w.filter[e[l].type].apply(null, e[l].matches))[I]) {
                                for (o = ++l; o < r && !w.relative[e[o].type]; o++)
                                    ;
                                return Ft(1 < l && qt(h), 1 < l && Rt(e.slice(0, l - 1).concat({
                                    value: " " === e[l - 2].type ? "*" : ""
                                })).replace(tt, "$1"), i, l < o && t(e.slice(l, o)), o < r && t(e = e.slice(o)), o < r && Rt(e))
                            }
                            h.push(i)
                        }
                    return qt(h)
                }(e[i]))[I] ? o : r).push(s);
            (s = dt(t, (y = 0 < (v = o).length,
            b = 0 < (g = r).length,
            n = function(t, e, i, n, o) {
                var r, s, a, l = 0, c = "0", u = t && [], h = [], d = ot, p = t || b && w.find.TAG("*", o), f = A += null == d ? 1 : Math.random() || .1, m = p.length;
                for (o && (ot = e == E || e || o); c !== m && null != (r = p[c]); c++) {
                    if (b && r) {
                        for (s = 0,
                        e || r.ownerDocument == E || (jt(r),
                        i = !S); a = g[s++]; )
                            if (a(r, e || E, i)) {
                                k.call(n, r);
                                break
    ...
    function $t(t, e, i, n) {
        var o, r, s, a, l, c = "function" == typeof t && t, u = !n && zt(t = c.selector || t);
        if (i = i || [],
        1 === u.length) {
            if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (s = r[0]).type && 9 === e.nodeType && S && w.relative[r[1].type]) {
                if (!(e = (w.find.ID(s.matches[0].replace(h, p), e) || [])[0]))
                    return i;
                c && (e = e.parentNode),
                t = t.slice(r.shift().value.length)
            }
            for (o = xt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o],
            !w.relative[a = s.type]); )
                if ((l = w.find[a]) && (n = l(s.matches[0].replace(h, p), St.test(r[0].type) && Pt(e.parentNode) || e))) {
                    if (r.splice(o, 1),
                    t = n.length && Rt(r))
                        break;
                    return k.apply(i, n),
        ...
        return (c || Wt(t, u))(n, e, !S, i, !e || St.test(t) && Pt(e.parentNode) || e),
        i
    }
    Mt.prototype = w.filters = w.pseudos,
    w.setFilters = new Mt,
    m.sortStable = I.split("").sort(ft).join("") === I,
    jt(),
    ...
    var Xt, Gt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, Zt = ((T.fn.init = function(t, e, i) {
        if (t) {
            if (i = i || Xt,
            "string" != typeof t)
            ...
            if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : Gt.exec(t)) || !n[1] && e)
            ...
            if (n[1]) {
                ...
                (i = C.getElementById(n[2])) && (this[0] = i,
                this.length = 1)
        }
        return this
    }
    ...
    T.fn.extend({
        ...
        closest: function(t, e) {
            var i, n = 0, o = this.length, r = [], s = "string" != typeof t && T(t);
            if (!Ut.test(t))
                for (; n < o; n++)
        ...
        index: function(t) {
            return t ? "string" == typeof t ? _.call(T(t), this[0]) : _.call(this, t.jquery ? t[0] : t) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1
        },
        add: function(t, e) {
    ...
    T.each({
        ...
        contents: function(t) {
            return null != t.contentDocument && N(t.contentDocument) ? t.contentDocument : (b(t, "template") && (t = t.content || t),
        ...
        T.fn[n] = function(t, e) {
            ...
            1 < this.length && (Kt[n] || T.uniqueSort(i),
            Zt.test(n)) && i.reverse(),
            this.pushStack(i)
        }
    });
    ...
    T.extend({
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(o < l)) {
                                    ...
                                    y(e) ? a ? e.call(t, c(l, r, te, a), c(l, r, ee, a)) : (l++,
                                    e.call(t, c(l, r, te, a), c(l, r, ee, a), c(l, r, te, r.notifyWith))) : (s !== te && (i = void 0,
                                    n = [t]),
                                    (a || r.resolveWith)(i, n))
                                }
                            }
        ...
        when: function(t) {
            ...
            var i = arguments.length
              ...
              , r = a.call(arguments)
              , s = T.Deferred();
            if (i <= 1 && (ie(t, s.done(e(n)).resolve, s.reject, !i),
    ...
    ue.prototype = {
        cache: function(t) {
            ...
            return e || (e = {},
            ce(t) && (t.nodeType ? t[this.expando] = e : Object.defineProperty(t, this.expando, {
                value: e,
                configurable: !0
            }))),
            e
    ...
    function pe(t, e, i) {
        ...
        if (void 0 === i && 1 === t.nodeType)
            if (n = "data-" + e.replace(de, "-$&").toLowerCase(),
        ...
        data: function(i, t) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var e;
                    if (r && void 0 === t)
                        return void 0 !== (e = c.get(r, i)) || void 0 !== (e = pe(r, i)) ? e : void 0;
                    this.each(function() {
                        c.set(this, i, t)
                    })
            ...
            1 === r.nodeType) && !v.get(r, "hasDataAttrs")) {
                for (e = s.length; e--; )
                    s[e] && 0 === (n = s[e].name).indexOf("data-") && (n = D(n.slice(5)),
                    pe(r, n, o[n]));
    ...
    T.fn.extend({
        ...
        promise: function(t, e) {
            ...
            var n, o = 1, r = T.Deferred(), s = this, a = this.length;
            for ("string" != typeof t && (e = t,
            t = void 0),
            t = t || "fx"; a--; )
                (n = v.get(s[a], t + "queueHooks")) && n.empty && (o++,
                n.empty.add(i));
            return i(),
            r.promise(e)
        }
    ...
    function _e(t, e, i, n) {
        ...
        , l = a(), c = i && i[3] || (T.cssNumber[e] ? "" : "px"), u = t.nodeType && (T.cssNumber[e] || "px" !== c && +l) && me.exec(T.css(t, e));
        if (u && u[3] !== c) {
            for (c = c || u[3],
            u = +(l /= 2) || 1; s--; )
                T.style(t, e, u + c),
    ...
    function xe(t, e) {
        for (var i, n, o, r, s, a, l = [], c = 0, u = t.length; c < u; c++)
            ...
            l[c] || (n.style.display = "")),
            "" === n.style.display && fe(n) && (l[c] = (a = r = o = void 0,
            r = n.ownerDocument,
            (a = we[s = n.nodeName]) || (o = r.body.appendChild(r.createElement(s)),
            a = T.css(o, "display"),
            o.parentNode.removeChild(o),
            we[s] = a = "none" === a ? "block" : a)))) : "none" !== i && (l[c] = "none",
            v.set(n, "display", i)));
        for (c = 0; c < u; c++)
    ...
    var Ce = /^(?:checkbox|radio)$/i
      ...
      , f = ((s = C.createElement("input")).setAttribute("type", "radio"),
    ...
    T.event = {
        ...
        add: function(e, t, i, n, o) {
            var r, s, a, l, c, u, h, d, p, f = v.get(e);
            if (ce(e))
                ...
                s = (s = f.handle) || (f.handle = function(t) {
                ...
                l = (t = (t || "").match(L) || [""]).length; l--; )
                    ...
                    c.setup && !1 !== c.setup.call(e, n, d, s)) || e.addEventListener && e.addEventListener(h, s),
        ...
        remove: function(t, e, i, n, o) {
            var r, s, a, l, c, u, h, d, p, f, m, g = v.hasData(t) && v.get(t);
            if (g && (l = g.events)) {
                for (c = (e = (e || "").match(L) || [""]).length; c--; )
                    if (p = m = (a = Ae.exec(e[c]) || [])[1],
                    f = (a[2] || "").split(".").sort(),
                    p) {
                        ...
                        s = r = d.length; r--; )
                            u = d[r],
                            !o && m !== u.origType || i && i.guid !== u.guid || a && !a.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(r, 1),
                            u.selector && d.delegateCount--,
                            h.remove && h.remove.call(t, u));
                        s && !d.length && (h.teardown && !1 !== h.teardown.call(t, f, g.handle) || T.removeEvent(t, p, g.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(t) {
            var e, i, n, o, r, s = new Array(arguments.length), a = T.event.fix(t), t = (v.get(this, "events") || Object.create(null))[a.type] || [], l = T.event.special[a.type] || {};
            for (s[0] = a,
            e = 1; e < arguments.length; e++)
                s[e] = arguments[e];
            if (a.delegateTarget = this,
            !l.preDispatch || !1 !== l.preDispatch.call(this, a)) {
                for (r = T.event.handlers.call(this, a, t),
                e = 0; (n = r[e++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (o = n.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        void 0 !== (o = ((T.event.special[o.origType] || {}).handle || o.handler).apply(n.elem, s)) && !1 === (a.result = o) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        ...
                        s = {},
                        i = 0; i < l; i++)
                            void 0 === s[o = (n = e[i]).selector + " "] && (s[o] = n.needsContext ? -1 < T(o, this).index(c) : T.find(o, this, null, [c]).length),
                            s[o] && r.push(n);
                        r.length && a.push({
                            elem: c,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    t = this || t;
                    return Ce.test(t.type) && t.click && b(t, "input") && Pe(t, "click", !0),
                    !1
                },
                trigger: function(t) {
                    t = this || t;
                    return Ce.test(t.type) && t.click && b(t, "input") && Pe(t, "click"),
                    !0
                },
                _default: function(t) {
                    t = t.target;
                    return Ce.test(t.type) && t.click && b(t, "input") && v.get(t, "click") || b(t, "a")
                }
            },
            beforeunload: {
    ...
    T.each({
        ...
        T.event.special[n] = {
            ...
            teardown: function() {
                ...
                if (!C.documentMode)
                    return !1;
                (t = v.get(this, o) - 1) ? v.set(this, o, t) : (this.removeEventListener(o, r),
                v.remove(this, o))
            },
            _default: function(t) {
        ...
        T.event.special[o] = {
            setup: function() {
                var t = this.ownerDocument || this.document || this
                  ...
                  , i = v.get(e, o);
                i || (C.documentMode ? this.addEventListener(o, r) : t.addEventListener(n, r, !0)),
                v.set(e, o, (i || 0) + 1)
            },
            teardown: function() {
                var t = this.ownerDocument || this.document || this
                  , e = C.documentMode ? this : t
                  , i = v.get(e, o) - 1;
                i ? v.set(e, o, i) : (C.documentMode ? this.removeEventListener(o, r) : t.removeEventListener(n, r, !0),
                v.remove(e, o))
            }
        }
    }),
    ...
    var je = /<script|<style|<link/i
      ...
      , ze = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
    function Re(t, e) {
        return b(t, "table") && b(11 !== e.nodeType ? e : e.firstChild, "tr") && T(t).children("tbody")[0] || t
    }
    function Ne(t) {
    ...
    function Fe(i, n, o, r) {
        n = q(n);
        var t, e, s, a, l, c, u = 0, h = i.length, d = h - 1, p = n[0], f = y(p);
        if (f || 1 < h && "string" == typeof p && !m.checkClone && Me.test(p))
            return i.each(function(t) {
                var e = i.eq(t);
                f && (n[0] = p.call(this, t, e.html())),
                Fe(e, n, o, r)
            });
        if (h && (e = (t = Ie(n, i[0].ownerDocument, !1, i, r)).firstChild,
        1 === t.childNodes.length && (t = e),
        e || r)) {
            for (a = (s = T.map(g(t, "script"), Ne)).length; u < h; u++)
                l = t,
                u !== d && (l = T.clone(l, !0, !0),
                a) && T.merge(s, g(l, "script")),
                o.call(i[u], l, u);
            if (a)
                ...
                u = 0; u < a; u++)
                    ...
                    }, c) : Q(l.textContent.replace(ze, ""), l, c))
        }
        return i
    }
    function We(t, e, i) {
        for (var n, o = e ? T.filter(e, t) : t, r = 0; null != (n = o[r]); r++)
            ...
            n.parentNode && (i && ye(n) && Se(g(n, "script")),
    ...
    T.extend({
        ...
        clone: function(t, e, i) {
            var n, o, r, s, a, l, c, u = t.cloneNode(!0), h = ye(t);
            if (!(m.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
                for (s = g(u),
                n = 0,
                o = (r = g(t)).length; n < o; n++)
                    a = r[n],
                    "input" === (c = (l = s[n]).nodeName.toLowerCase()) && Ce.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (r = r || g(t),
                    s = s || g(u),
                    ...
                    He(t, u);
            return 0 < (s = g(u, "script")).length && Se(s, !h && g(t, "script")),
            u
        },
    ...
    T.fn.extend({
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (T.cleanData(g(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return u(this, function(t) {
                ...
                if (void 0 === t && 1 === e.nodeType)
                    return e.innerHTML;
                if ("string" == typeof t && !je.test(t) && !f[(Te.exec(t) || ["", ""])[1].toLowerCase()]) {
                    t = T.htmlPrefilter(t);
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (T.cleanData(g(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return Fe(this, arguments, function(t) {
                ...
                T.inArray(this, i) < 0 && (T.cleanData(g(this)),
    ...
    var Ve, Ue, Qe, Ye, Xe, Ge, Ze, P, Ke = new RegExp("^(" + t + ")(?!px)[a-z%]+$","i"), Je = /^--/, ti = new RegExp(ge.join("|"),"i");
    function ei(t, e, i) {
        var n, o = Je.test(e), r = t.style;
        return (i = i || $e(t)) && (n = i.getPropertyValue(e) || i[e],
        "" !== (n = o ? n && (n.replace(tt, "$1") || void 0) : n) || ye(t) || (n = T.style(t, e)),
        !m.pixelBoxStyles()) && Ke.test(n) && ti.test(e) && (o = r.width,
        t = r.minWidth,
        e = r.maxWidth,
    ...
    function ni() {
        var t;
        P && (Ze.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
        ...
        ve.appendChild(Ze).appendChild(P),
        t = x.getComputedStyle(P),
        Ve = "1%" !== t.top,
    ...
    (P = C.createElement("div")).style && (P.style.backgroundClip = "content-box",
    ...
    var ri = ["Webkit", "Moz", "ms"]
      ...
      , ai = {};
    function li(t) {
        return T.cssProps[t] || ai[t] || (t in si ? t : ai[t] = (t => {
    ...
    function pi(t, e, i, n, o, r) {
        ...
        for (; s < 4; s += 2)
            ...
            n ? ("content" === i && (l -= T.css(t, "padding" + ge[s], !0, o)),
            "margin" !== i && (l -= T.css(t, "border" + ge[s] + "Width", !0, o))) : (l += T.css(t, "padding" + ge[s], !0, o),
            "padding" !== i ? l += T.css(t, "border" + ge[s] + "Width", !0, o) : a += T.css(t, "border" + ge[s] + "Width", !0, o));
    ...
    function fi(t, e, i) {
        ...
        return (!m.boxSizingReliable() && o || !m.reliableTrDimensions() && b(t, "tr") || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, n)) && t.getClientRects().length && (o = "border-box" === T.css(t, "boxSizing", !1, n),
        r = a in t) && (s = t[a]),
        (s = parseFloat(s) || 0) + pi(t, e, i || (o ? "border" : "content"), r, n, s) + "px"
    }
    ...
    T.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = D(e), l = Je.test(e), c = t.style;
                if (l || (e = li(a)),
                s = T.cssHooks[e] || T.cssHooks[a],
                void 0 === i)
                    return s && "get"in s && void 0 !== (o = s.get(t, !1, n)) ? o : c[e];
                "string" == (r = typeof i) && (o = me.exec(i)) && o[1] && (i = _e(t, e, o),
                r = "number"),
                null != i && i == i && ("number" !== r || l || (i += o && o[3] || (T.cssNumber[a] ? "" : "px")),
        ...
        css: function(t, e, i, n) {
            var o, r = D(e);
            return Je.test(e) || (e = li(r)),
            "normal" === (o = void 0 === (o = (r = T.cssHooks[e] || T.cssHooks[r]) && "get"in r ? r.get(t, !0, i) : o) ? ei(t, e, n) : o) && e in hi && (o = hi[e]),
            ("" === i || i) && (r = parseFloat(o),
    ...
    T.each(["height", "width"], function(t, s) {
        T.cssHooks[s] = {
            get: function(t, e, i) {
                if (e)
                    return !ci.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? fi(t, s, i) : Be(t, ui, function() {
                        return fi(t, s, i)
                    })
            },
            set: function(t, e, i) {
                var n = $e(t)
                  ...
                  , i = i ? pi(t, s, i, r, n) : 0;
                return r && o && (i -= Math.ceil(t["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(n[s]) - pi(t, s, "border", !1, n) - .5)),
                i && (r = me.exec(e)) && "px" !== (r[3] || "px") && (t.style[s] = e,
                e = T.css(t, s)),
                di(0, e, i)
            }
        }
    ...
    function xi(t, e, i) {
        for (var n, o = (M.tweeners[e] || []).concat(M.tweeners["*"]), r = 0, s = o.length; r < s; r++)
            if (n = o[r].call(i, e, t))
                return n
    }
    function M(o, t, e) {
        var i, r, n, s, a, l, c, u = 0, h = M.prefilters.length, d = T.Deferred().always(function() {
            delete p.elem
        }), p = function() {
            if (r)
                return !1;
        ...
        for (n in g)
            ...
            (c = T.cssHooks[s]) && "expand"in c)
                ...
                v[s] = a;
        for (; u < h; u++)
            if (i = M.prefilters[u].call(f, o, m, f.opts))
    ...
    T.Animation = T.extend(M, {
        tweeners: {
            "*": [function(t, e) {
                ...
                return _e(i.elem, t, me.exec(e), i),
                i
            }
            ]
        },
        tweener: function(t, e) {
            ...
            ["*"]) : t.match(L)).length; n < o; n++)
                i = t[n],
                M.tweeners[i] = M.tweeners[i] || [],
                M.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, o, r, s, a, l, c, u = "width"in e || "height"in e, h = this, d = {}, p = t.style, f = t.nodeType && fe(t), m = v.get(t, "fxshow");
    ...
    T.fn.extend({
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var t, e = v.get(this), i = e[s + "queue"], n = e[s + "queueHooks"], o = T.timers, r = i ? i.length : 0;
                for (e.finish = !0,
                T.queue(this, s, []),
    ...
    T.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === t.getAttribute ? T.prop(t, e, i) : (1 === r && T.isXMLDoc(t) || (o = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? Ci : void 0)),
    ...
    /^(?:input|select|textarea|button)$/i), Si = /^(?:a|area)$/i;
    function ki(t) {
        ...
        propHooks: {
            tabIndex: {
                get: function(t) {
                    ...
                    return e ? parseInt(e, 10) : Ei.test(t.nodeName) || Si.test(t.nodeName) && t.href ? 0 : -1
                }
            }
        },
        propFix: {
    ...
    T.fn.extend({
        addClass: function(e) {
            ...
            return y(e) ? this.each(function(t) {
                T(this).addClass(e.call(this, t, Ii(this)))
            }) : (t = Ai(e)).length ? this.each(function() {
                if (n = Ii(this),
        ...
        removeClass: function(e) {
            var t, i, n, o, r, s;
            return y(e) ? this.each(function(t) {
                T(this).removeClass(e.call(this, t, Ii(this)))
            }) : arguments.length ? (t = Ai(e)).length ? this.each(function() {
                if (n = Ii(this),
                i = 1 === this.nodeType && " " + ki(n) + " ") {
                    for (r = 0; r < t.length; r++)
        ...
        toggleClass: function(e, i) {
            var t, n, o, r, s = typeof e, a = "string" == s || Array.isArray(e);
            return y(e) ? this.each(function(t) {
                T(this).toggleClass(e.call(this, t, Ii(this), i), i)
            }) : "boolean" == typeof i && a ? i ? this.addClass(e) : this.removeClass(e) : (t = Ai(e),
            this.each(function() {
                if (a)
                    for (r = T(this),
                    o = 0; o < t.length; o++)
    ...
    T.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, o = t.options, r = T.makeArray(e), s = o.length; s--; )
    ...
    /^(?:focusinfocus|focusoutblur)$/)
      , zi = (T.extend(T.event, {
        trigger: function(t, e, i, n) {
            var o, r, s, a, l, c, u, h = [i || C], d = $.call(t, "type") ? t.type : t, p = $.call(t, "namespace") ? t.namespace.split(".") : [], f = u = r = i = i || C;
            if (3 !== i.nodeType && 8 !== i.nodeType && !Mi.test(d + T.event.triggered) && (-1 < d.indexOf(".") && (d = (p = d.split(".")).shift(),
            p.sort()),
            a = d.indexOf(":") < 0 && "on" + d,
            ...
            n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                if (!n && !c.noBubble && !R(i)) {
                    ...
                    Mi.test(s + d) || (f = f.parentNode); f; f = f.parentNode)
                        h.push(f),
                        r = f;
                    r === (i.ownerDocument || C) && h.push(r.defaultView || r.parentWindow || x)
                }
                for (o = 0; (f = h[o++]) && !t.isPropagationStopped(); )
                    ...
                    (l = a && f[a]) && l.apply && ce(f) && (t.result = l.apply(f, e),
                    !1 === t.result) && t.preventDefault();
                return t.type = d,
                n || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), e) || !ce(i) || a && y(i[d]) && !R(i) && ((r = i[a]) && (i[a] = null),
                T.event.triggered = d,
        ...
        if (Array.isArray(t) || t.jquery && !T.isPlainObject(t))
            ...
            for (n in t)
                !function i(n, t, o, r) {
                    if (Array.isArray(t))
                        T.each(t, function(t, e) {
                            o || zi.test(n) ? r(n, e) : i(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, o, r)
                        });
    ...
    T.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !T(this).is(":disabled") && qi.test(this.nodeName) && !Ni.test(t) && (this.checked || !Ce.test(t))
            }).map(function(t, e) {
                var i = T(this).val();
    ...
    function Gi(r) {
        return function(t, e) {
            "string" != typeof t && (e = t,
            t = "*");
            var i, n = 0, o = t.toLowerCase().match(L) || [];
            if (y(e))
                for (; i = o[n++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function Zi(e, n, o, r) {
        ...
        function l(t) {
            ...
            T.each(e[t] || [], function(t, e) {
                e = e(n, o, r);
                return "string" != typeof e || a || s[e] ? a ? !(i = e) : void 0 : (n.dataTypes.unshift(e),
                l(e),
                !1)
            }),
            i
    ...
    T.extend({
        ...
        ajaxSettings: {
            url: Di.href,
            type: "GET",
            isLocal: /^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(Di.protocol),
            global: !0,
            processData: !0,
            async: !0,
        ...
        ajax: function(t, e) {
            "object" == typeof t && (e = t,
            t = void 0);
            var l, c, u, i, h, d, p, n, o, f = T.ajaxSetup({}, e = e || {}), m = f.context || f, g = f.context && (m.nodeType || m.jquery) ? T(m) : T.event, v = T.Deferred(), y = T.Callbacks("once memory"), b = f.statusCode || {}, r = {}, s = {}, a = "canceled", _ = {
                readyState: 0,
            ...
            if (v.promise(_),
            f.url = ((t || f.url || Di.href) + "").replace(Vi, Di.protocol + "//"),
            ...
            !d) {
                ...
                c = f.url.replace(Fi, ""),
                f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Hi, "+")) : (o = f.url.slice(c.length),
                f.data && (f.processData || "string" == typeof f.data) && (c += (ji.test(c) ? "&" : "?") + f.data,
                delete f.data),
                !1 === f.cache && (c = c.replace(Wi, "$1"),
                o = (ji.test(c) ? "&" : "?") + "_=" + Pi.guid++ + o),
                f.url = c + o),
            ...
            function w(t, e, i, n) {
                ...
                204 === t || "HEAD" === f.type ? a = "nocontent" : 304 === t ? a = "notmodified" : (a = s.state,
                o = s.data,
                n = !(r = s.error))) : (r = a,
                !t && a || (a = "error",
                t < 0 && (t = 0))),
    ...
    var en = []
      ...
      , on = (T.ajaxSetup({
        ...
        jsonpCallback: function() {
            var t = en.pop() || T.expando + "_" + Pi.guid++;
            return this[t] = !0,
            t
        }
    }),
    T.ajaxPrefilter("json jsonp", function(t, e, i) {
        var n, o, r, s = !1 !== t.jsonp && (nn.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && nn.test(t.data) && "data");
        if (s || "jsonp" === t.dataTypes[0])
            return n = t.jsonpCallback = y(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            s ? t[s] = t[s].replace(nn, "$1" + n) : !1 !== t.jsonp && (t.url += (ji.test(t.url) ? "&" : "?") + t.jsonp + "=" + n),
    ...
    T.parseHTML = function(t, e, i) {
        ...
        n = !i && [],
        (i = Qt.exec(t)) ? [e.createElement(i[1])] : (i = Ie([t], e, n),
    ...
    T.offset = {
        setOffset: function(t, e, i) {
            var n, o, r, s, a = T.css(t, "position"), l = T(t), c = {};
            "static" === a && (t.style.position = "relative"),
            r = l.offset(),
            n = T.css(t, "top"),
            s = T.css(t, "left"),
            a = ("absolute" === a || "fixed" === a) && -1 < (n + s).indexOf("auto") ? (o = (a = l.position()).top,
            a.left) : (o = parseFloat(n) || 0,
            parseFloat(s) || 0),
            null != (e = y(e) ? e.call(t, i, T.extend({}, r)) : e).top && (c.top = e.top - r.top + o),
    ...
    T.fn.extend({
        offset: function(e) {
            ...
            }) : (i = this[0]) ? i.getClientRects().length ? (t = i.getBoundingClientRect(),
    ...
    T.each({
        ...
        T.each({
            ...
            T.fn[r] = function(t, e) {
                ...
                return u(this, function(t, e, i) {
                    var n;
                    return R(t) ? 0 === r.indexOf("outer") ? t["inner" + s] : t.document.documentElement["client" + s] : 9 === t.nodeType ? (n = t.documentElement,
                    Math.max(t.body["scroll" + s], n["scroll" + s], t.body["offset" + s], n["offset" + s], n["client" + s])) : void 0 === i ? T.css(t, e, o) : T.style(t, e, i, o)
                }, a, i ? t : void 0, i)
            }
        })
    }),
...
( (t, e) => {
    ...
    let n = new Map
      ...
      , o = t => s(t) ? t.jquery ? t[0] : t : "string" == typeof t && 0 < t.length ? document.querySelector(N(t)) : null
      , r = e => {
      ...
      , U = (t, e, i, n) => {
        var o = t.length;
        let r = t.indexOf(e);
        return -1 === r ? !i && n ? t[o - 1] : t[0] : (r += i ? 1 : -1,
        n && (r = (r + o) % o),
    ...
    function ot(n, o, r, s, a) {
        if ("string" == typeof o && n) {
            ...
            var c, u, h, d, p, l = tt(e, o.replace(Q, "")), o = t ? (h = n,
            d = r,
            p = e,
            function e(i) {
                    ...
                    if (i)
                        for (let t of Object.keys(r)) {
                            ...
                            for ([m,g] of Object.entries(v))
                                m.includes(f) && rt(h, d, p, g.callable, g.delegationSelector)
                        }
                    for (let[e,i] of Object.entries(s)) {
                        let t = e.replace(X, "");
                        o && !l.includes(t) || rt(a, r, n, i.callable, i.delegationSelector)
                    }
                } else
                    Object.keys(s).length && rt(a, r, n, e, t ? c : null)
            }
        },
        trigger(t, e, i) {
    ...
    let u = {
        ...
        getDataAttributes(e) {
            if (!e)
                return {};
            var i, n = {};
            for (i of Object.keys(e.dataset).filter(t => t.startsWith("bs") && !t.startsWith("bsConfig"))) {
                let t = i.replace(/^bs/, "");
                n[t = t.charAt(0).toLowerCase() + t.slice(1, t.length)] = lt(e.dataset[i])
            }
            return n
        },
    ...
    class ut {
        ...
        _typeCheckConfig(i, t=this.constructor.DefaultType) {
            for (var [n,o] of Object.entries(t)) {
                let t = i[n]
                  , e = s(t) ? "element" : null == (r = t) ? "" + r : Object.prototype.toString.call(r).match(/\s([a-z]+)/i)[1].toLowerCase();
                if (!new RegExp(o).test(e))
                    throw new TypeError(`${this.constructor.NAME.toUpperCase()}: Option "${n}" provided type "${e}" but expected type "${o}".`)
            }
            var r
        }
    }
    class e extends ut {
        ...
        dispose() {
            ...
            for (var t of Object.getOwnPropertyNames(this))
                this[t] = null
        }
        ...
        static getInstance(t) {
            return z.get(o(t), this.DATA_KEY)
        }
    ...
    let ht = e => {
        ...
        return i ? i.split(",").map(t => N(t)).join(",") : null
    }
      , h = {
    ...
    class Ot extends e {
        ...
        _maybeEnableCycle() {
            this._config.ride && (this._isSliding ? f.one(this._element, xt, () => this.cycle()) : this.cycle())
        }
        to(t) {
            var e, i = this._getItems();
            t > i.length - 1 || t < 0 || (this._isSliding ? f.one(this._element, xt, () => this.to(t)) : (e = this._getItemIndex(this._getActive())) !== t && (e = e < t ? _t : d,
            this._slide(e, i[t])))
        }
        dispose() {
        ...
        _setActiveIndicatorElement(t) {
            var e;
            this._indicatorsElement && ((e = h.findOne(Et, this._indicatorsElement)).classList.remove(Tt),
            e.removeAttribute("aria-current"),
            e = h.findOne(`[data-bs-slide-to="${t}"]`, this._indicatorsElement)) && (e.classList.add(Tt),
    ...
    class zt extends e {
        ...
        show() {
            if (!this._isTransitioning && !this._isShown()) {
                let e = [];
                if (!((e = this._config.parent ? this._getFirstLevelChildren(".collapse.show, .collapse.collapsing").filter(t => t !== this._element).map(t => zt.getOrCreateInstance(t, {
                    toggle: !1
        ...
        _initializeChildren() {
            if (this._config.parent) {
                let t = this._getFirstLevelChildren(Pt);
                for (var e of t) {
        ...
        static jQueryInterface(e) {
            ...
            this.each(function() {
                var t = zt.getOrCreateInstance(this, i);
                if ("string" == typeof e) {
                    if (void 0 === t[e])
                        throw new TypeError(`No method named "${e}"`);
                    t[e]()
    ...
    f.on(document, "click.bs.collapse.data-api", Pt, function(t) {
    ...
    var k = "top"
      ...
      , Wt = L.reduce(function(t, e) {
        return t.concat([e + "-" + D, e + "-" + b])
    }, [])
      , $t = [].concat(L, [Rt]).reduce(function(t, e) {
        return t.concat([e, e + "-" + D, e + "-" + b])
    }, [])
      , Bt = "beforeRead"
      , Vt = "afterRead"
      , Ut = "beforeMain"
        ...
        fn: function(t) {
            ...
            Object.keys(o.elements).forEach(function(t) {
                var e = o.styles[t] || {}
                  , i = o.attributes[t] || {}
                  , n = o.elements[t];
                y(n) && g(n) && (Object.assign(n.style, e),
        ...
        effect: function(t) {
            ...
            function() {
                Object.keys(n.elements).forEach(function(t) {
                    ...
                    y(e) && g(e) && (Object.assign(e.style, t),
                    Object.keys(i).forEach(function(t) {
                        e.removeAttribute(t)
                    }))
                })
    ...
    function ne(t, e, i) {
        ...
        var n = t.getBoundingClientRect()
          , o = 1
          , r = 1
          , e = (e && y(t) && (o = 0 < t.offsetWidth && te(n.width) / t.offsetWidth || 1,
    ...
    function se(t) {
        return "html" === g(t) ? t : t.assignedSlot || t.parentNode || (Zt(t) ? t.host : null) || x(t)
    }
    function ae(t) {
        return y(t) && "fixed" !== w(t).position ? t.offsetParent : null
    }
    function le(t) {
        for (var e, i = _(t), n = ae(t); n && (e = n,
        0 <= ["table", "td", "th"].indexOf(g(e))) && "static" === w(n).position; )
            n = ae(n);
        return (!n || "html" !== g(n) && ("body" !== g(n) || "static" !== w(n).position)) && (n || (t => {
            var e = /firefox/i.test(ee());
            if (!/Trident/i.test(ee()) || !y(t) || "fixed" !== w(t).position) {
                var i = se(t);
                for (Zt(i) && (i = i.host); y(i) && ["html", "body"].indexOf(g(i)) < 0; ) {
                    var n = w(i);
    ...
    var pe = {
        ...
        phase: "main",
        fn: function(t) {
            var e, i, n, o, r = t.state, s = t.name, t = t.options, a = r.elements.arrow, l = r.modifiersData.popperOffsets, c = P(r.placement), u = ce(c), c = 0 <= [O, A].indexOf(c) ? "height" : "width";
            a && l && (t = he("number" != typeof (t = "function" == typeof (t = t.padding) ? t(Object.assign({}, r.rects, {
                placement: r.placement
            })) : t) ? t : de(t, L)),
            e = oe(a),
            o = "y" === u ? k : O,
            n = "y" === u ? I : A,
            i = r.rects.reference[c] + r.rects.reference[u] - l[u] - r.rects.popper[c],
            l = l[u] - r.rects.reference[u],
            a = (a = le(a)) ? "y" === u ? a.clientHeight || 0 : a.clientWidth || 0 : 0,
            o = t[o],
            t = a - e[c] - t[n],
            o = ue(o, n = a / 2 - e[c] / 2 + (i / 2 - l / 2), t),
            r.modifiersData[s] = ((a = {})[u] = o,
            a.centerOffset = o - n,
            a))
        },
        effect: function(t) {
    ...
    function ge(t) {
        ...
        l && (v = "clientHeight",
        g = "clientWidth",
        (y = le(e)) === _(e) && "static" !== w(y = x(e)).position && "absolute" === s && (v = "scrollHeight",
        g = "scrollWidth"),
        n !== k && (n !== O && n !== A || o !== b) || (f = I,
    ...
    function ke(t, e) {
        void 0 === e && (e = []);
        var i = function t(e) {
            return 0 <= ["html", "body", "#document"].indexOf(g(e)) ? e.ownerDocument.body : y(e) && Se(e) ? e : t(se(e))
        }(t)
    ...
    function Ae(t, e, i) {
        ...
        u = s.offsetTop),
        {
            ...
            x: c + Ee(n),
            y: u
        })) : v(e) ? ((o = ne(r = e, !1, "fixed" === i)).top = o.top + r.clientTop,
        ...
        s = -a.scrollLeft + Ee(s),
        a = -a.scrollTop,
        "rtl" === w(c || l).direction && (s += S(l.clientWidth, c ? c.clientWidth : 0) - n),
        {
            width: n,
            height: u,
            x: s,
    ...
    function Oe(t) {
        var e, i = t.reference, n = t.element, t = t.placement, o = t ? P(t) : null, t = t ? fe(t) : null, r = i.x + i.width / 2 - n.width / 2, s = i.y + i.height / 2 - n.height / 2;
        switch (o) {
        case k:
            e = {
                x: r,
    ...
    function Le(t, e) {
        ...
        (p = s.reduce(function(t, e) {
            ...
            t
        }, Ae(i, h, n))).width = p.right - p.left,
        p.height = p.bottom - p.top,
        p.x = p.left,
        p.y = p.top,
        p), u = ne(t.elements.reference), h = Oe({
            reference: u,
            element: f,
            strategy: "absolute",
            placement: l
        }), p = Ie(Object.assign({}, f, h)), f = d === Ht ? p : u, m = {
        ...
        Object.keys(m).forEach(function(t) {
            var e = 0 <= [A, I].indexOf(t) ? 1 : -1
              , i = 0 <= [k, I].indexOf(t) ? "y" : "x";
            m[t] += a[i] * e
        })),
        m
    }
    var De = {
        ...
        fn: function(t) {
            ...
            if (!h.modifiersData[t]._skip) {
                for (var i = e.mainAxis, n = void 0 === i || i, i = e.altAxis, o = void 0 === i || i, i = e.fallbackPlacements, d = e.padding, p = e.boundary, f = e.rootBoundary, r = e.altBoundary, s = e.flipVariations, m = void 0 === s || s, g = e.allowedAutoPlacements, s = h.options.placement, e = P(s), i = i || (e !== s && m ? P(i = s) === Rt ? [] : (e = we(i),
                [Ce(i), e, Ce(e)]) : [we(s)]), a = [s].concat(i).reduce(function(t, e) {
                    return t.concat(P(e) === Rt ? (i = h,
                    n = (t = t = void 0 === (t = {
                        placement: e,
                        boundary: p,
                        rootBoundary: f,
    ...
    function je(e) {
        return [k, A, I, O].some(function(t) {
            return 0 <= e[t]
        })
    }
    var Me = {
      ...
      , Ne = {
        ...
        phase: "main",
        fn: function(t) {
            var e, i, n, o, r, s, a, l, c, u = t.state, h = t.options, t = t.name, d = h.mainAxis, d = void 0 === d || d, p = h.altAxis, p = void 0 !== p && p, f = h.tether, f = void 0 === f || f, m = h.tetherOffset, m = void 0 === m ? 0 : m, h = Le(u, {
                boundary: h.boundary,
                rootBoundary: h.rootBoundary,
                padding: h.padding,
                altBoundary: h.altBoundary
            }), g = P(u.placement), v = fe(u.placement), y = !v, b = ce(g), _ = "x" === b ? "y" : "x", w = u.modifiersData.popperOffsets, x = u.rects.reference, C = u.rects.popper, m = "function" == typeof m ? m(Object.assign({}, u.rects, {
                ...
                mainAxis: 0,
                altAxis: 0
            }, m), T = u.modifiersData.offset ? u.modifiersData.offset[u.placement] : null, E = {
                x: 0,
                y: 0
            };
            ...
            n = n[c],
            c = ue(0, x[d], r[d]),
            r = y ? x[d] / 2 - e - c - i - m.mainAxis : o - c - i - m.mainAxis,
            o = y ? -x[d] / 2 + e + c + n + m.mainAxis : v + c + n + m.mainAxis,
            y = (i = u.elements.arrow && le(u.elements.arrow)) ? "y" === b ? i.clientTop || 0 : i.clientLeft || 0 : 0,
        ...
        return function(n, o, e) {
            ...
            var i, r, p = {
                ...
                setOptions: function(t) {
                    ...
                    p.scrollParents = {
                        reference: v(n) ? ke(n) : n.contextElement ? ke(n.contextElement) : [],
                        popper: ke(o)
                    };
                    ...
                    i = qe(Object.keys(e).map(function(t) {
                        return e[t]
                    }));
                    ...
                    if (!f) {
                        ...
                        if (Fe(e, t)) {
                            p.rects = {
                                ...
                                l = y(s),
                                c = y(s) && (h = (c = s).getBoundingClientRect(),
                                ...
                                !l && a || ("body" === g(s) && !Se(u) || (e = (l = s) !== _(l) && y(l) ? {
                                    scrollLeft: l.scrollLeft,
                                    scrollTop: l.scrollTop
                                } : Te(l)),
                                y(s) ? ((d = ne(s, !0)).x += s.clientLeft,
                                d.y += s.clientTop) : u && (d.x = Ee(u))),
                                {
                            ...
                            for (var i, n, o, r = 0; r < p.orderedModifiers.length; r++)
                                !0 !== p.reset ? (n = (i = p.orderedModifiers[r]).fn,
                                o = i.options,
            ...
            return Fe(n, o) && m.setOptions(e).then(function(t) {
    ...
    var $e = We()
      ...
      , Ve = We({
        defaultModifiers: [be, Re, ve, Kt, ze, De, Ne, pe, Me]
    });
    let Ue = Object.freeze(Object.defineProperty({
        __proto__: null,
        afterMain: Qt,
        afterRead: Vt,
        afterWrite: Xt,
    ...
    class T extends e {
        constructor(t, e) {
            ...
            this._menu = h.next(this._element, ti)[0] || h.prev(this._element, ti)[0] || h.findOne(ti, this._parent),
        ...
        _getPlacement() {
            ...
            return e.classList.contains("dropend") ? ri : e.classList.contains("dropstart") ? si : e.classList.contains("dropup-center") ? "top" : e.classList.contains("dropdown-center") ? "bottom" : (t = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(),
        ...
        static clearMenus(e) {
            if (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key)) {
                let t = h.find('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled).show');
                for (var i of t) {
                    let t = T.getInstance(i);
                    var n;
                    t && !1 !== t._config.autoClose && (n = (i = e.composedPath()).includes(t._menu),
                    i.includes(t._element) || "inside" === t._config.autoClose && !n || "outside" === t._config.autoClose && n || t._menu.contains(e.target) && ("keyup" === e.type && "Tab" === e.key || /input|select|option|textarea|form/i.test(e.target.tagName)) || (i = {
        ...
        static dataApiKeydownHandler(t) {
            ...
            e = this.matches(C) ? this : h.prev(this, C)[0] || h.next(this, C)[0] || h.findOne(C, t.delegateTarget.parentNode),
    ...
    f.on(document, Ze, C, function(t) {
        t.preventDefault(),
        T.getOrCreateInstance(this).toggle()
    }),
    t(T);
    let ci = "backdrop"
      , ui = "mousedown.bs." + ci
    ...
    class pi extends ut {
        ...
        dispose() {
            this._isAppended && (f.off(this._element, ui),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
        ...
        _configAfterMerge(t) {
            return t.rootElement = o(t.rootElement),
            t
        }
        _append() {
            var t;
    ...
    class yi extends ut {
        ...
        _handleFocusin(t) {
            ...
            t.target === document || t.target === e || e.contains(t.target) || (0 === (t = h.focusableChildren(e)).length ? e : this._lastTabNavDirection === mi ? t[t.length - 1] : t[0]).focus()
        }
        _handleKeydown(t) {
    ...
    class Ci {
        ...
        _applyManipulationCallback(t, e) {
            if (s(t))
                ...
                for (var i of h.find(t, this._element))
                    e(i)
        }
    }
    let E = ".bs.modal"
    ...
    class Oi extends e {
        ...
        show(t) {
            this._isShown || this._isTransitioning || f.trigger(this._element, Ei, {
                relatedTarget: t
    ...
    class j extends e {
        ...
        _initializeBackDrop() {
            ...
            return new pi({
                ...
                clickCallback: t ? () => {
                    "static" !== this._config.backdrop ? this.hide() : f.trigger(this._element, ji)
                }
                : null
            })
        }
        ...
        _addEventListeners() {
            f.on(this._element, "keydown.dismiss.bs.offcanvas", t => {
                "Escape" === t.key && (this._config.keyboard ? this.hide() : f.trigger(this._element, ji))
            }
            )
        }
        static jQueryInterface(e) {
            return this.each(function() {
                var t = j.getOrCreateInstance(this, e);
                if ("string" == typeof e) {
                    if (void 0 === t[e] || e.startsWith("_") || "constructor" === e)
                        throw new TypeError(`No method named "${e}"`);
                    t[e](this)
    ...
    class Bi extends ut {
        ...
        toHtml() {
            ...
            return e && t.classList.add(...e.split(" ")),
            t
        }
        _typeCheckConfig(t) {
        ...
        _setContent(t, e, i) {
            i = h.findOne(i, t);
            i && ((e = this._resolvePossibleFunction(e)) ? s(e) ? this._putElementInTemplate(o(e), i) : this._config.html ? i.innerHTML = this._maybeSanitize(e) : i.textContent = e : i.remove())
        }
        _maybeSanitize(i) {
                    ...
                    if (Object.keys(o).includes(t)) {
                        ...
                        for (let t of e)
                            ( (t, e) => {
                                ...
                                return e.includes(i) ? !qi.has(i) || Boolean(Hi.test(t.nodeValue)) : e.filter(t => t instanceof RegExp).some(t => t.test(i))
                            }
    ...
    class tn extends e {
        ...
        _createTipElement(t) {
            ...
            this._isAnimated() && t.classList.add(Ui),
            t
        }
        setContent(t) {
            this._newContent = t,
        ...
        _getTemplateFactory(t) {
            return this._templateFactory ? this._templateFactory.changeContent(t) : this._templateFactory = new Bi({
                ...this._config,
                content: t,
        ...
        _setListeners() {
            ...
            for (var i of t)
                if ("click" === i)
                    ...
                    let t = i === Xi ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin")
                      , e = i === Xi ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout");
                    ...
                    f.on(this._element, e, this._config.selector, t => {
                        var e = this._initializeOnDelegatedTarget(t);
                        e._activeTrigger["focusout" === t.type ? Gi : Xi] = e._element.contains(t.relatedTarget),
                        e._leave()
                    }
                    )
                }
        ...
        _configAfterMerge(t) {
            return t.container = !1 === t.container ? document.body : o(t.container),
    ...
    class hn extends e {
        ...
        _configAfterMerge(t) {
            return t.target = o(t.target) || document.body,
            t.rootMargin = t.offset ? t.offset + "px 0px -30%" : t.rootMargin,
            "string" == typeof t.threshold && (t.threshold = t.threshold.split(",").map(t => Number.parseFloat(t))),
            t
        }
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (f.off(this._config.target, sn),
        ...
        _observerCallback(t) {
            ...
            for (var r of t)
                if (r.isIntersecting) {
                    let t = r.target.offsetTop >= this._previousScrollData.visibleEntryTop;
                    if (o && t) {
                        if (i(r),
                        !n)
                            return
        ...
        _initializeTargetsAndObservables() {
            ...
            for (var e of t)
                if (e.hash && !a(e)) {
                    ...
                    r(t) && (this._targetLinks.set(decodeURI(e.hash), e),
        ...
        _activateParents(t) {
            if (t.classList.contains("dropdown-item"))
                h.findOne(".dropdown-toggle", t.closest(".dropdown")).classList.add(an);
            else
                for (var e of h.parents(t, ".nav, .list-group"))
                    for (let t of h.prev(e, ".nav-link, .nav-item > .nav-link, .list-group-item"))
                        t.classList.add(an)
        }
        _clearActiveClass(t) {
    ...
    f.on(window, "load.bs.scrollspy.data-api", () => {
        for (var t of h.find('[data-bs-spy="scroll"]'))
            hn.getOrCreateInstance(t)
    }
    ),
    t(hn);
    let dn = "ArrowRight"
    ...
    class _n extends e {
        ...
        _keydown(e) {
            if (["ArrowLeft", dn, "ArrowUp", pn, fn, "End"].includes(e.key)) {
                ...
                let t;
                (t = [fn, "End"].includes(e.key) ? n[e.key === fn ? 0 : n.length - 1] : (i = [dn, pn].includes(e.key),
                U(n, e.target, i, !0))) && (t.focus({
                    preventScroll: !0
                }),
    ...
    f.on(window, "load.bs.tab", () => {
        for (var t of h.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]'))
    ...
    class En extends e {
        ...
        hide() {
            !this.isShown() || f.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(xn),
            this._queueCallback( () => {
...
(t => {
    ...
    u.extend(u.fn, {
        ...
        rules: function(t, e) {
            var i, n, o, r, s, a = this[0], l = void 0 !== this.attr("contenteditable") && "false" !== this.attr("contenteditable");
            ...
            null != a.form)) {
                ...
                return (l = u.validator.normalizeRules(u.extend({}, u.validator.classRules(a), u.validator.attributeRules(a), u.validator.dataRules(a), u.validator.staticRules(a)), a)).required && (r = l.required,
                delete l.required,
                l = u.extend({
                    required: r
                }, l)),
    ...
    u.extend(u.validator, {
        ...
        prototype: {
            ...
            elements: function() {
                var i = this
                  , n = {};
                return u(this.currentForm).find(["input", "select", "textarea", "[contenteditable]"].concat(this.settings.customElements).join(", ")).not(":submit, :reset, :image, :disabled").not(this.settings.ignore).filter(function() {
            ...
            check: function(e) {
                ...
                var t, i, n, o, r = u(e).rules(), s = u.map(r, function(t, e) {
                    return e
                ...
                r) {
                    ...
                    try {
                        if ("dependency-mismatch" === (t = u.validator.methods[i].call(this, l, e, n.parameters)) && 1 === s)
                            a = !0;
                        else {
                            if (a = !1,
                            "pending" === t)
            ...
            showLabel: function(t, e) {
                var i, n, o, r = this.errorsFor(t), s = this.idOrName(t), a = u(t).attr("aria-describedby");
                r.length ? (r.removeClass(this.settings.validClass).addClass(this.settings.errorClass),
                this.settings && this.settings.escapeHtml ? r.text(e || "") : r.html(e || "")) : (r = u("<" + this.settings.errorElement + ">").attr("id", s + "-error").addClass(this.settings.errorClass),
                ...
                r.is("label") ? r.attr("for", s) : 0 === r.parents("label[for='" + this.escapeCssMeta(s) + "']").length && (n = r.attr("id"),
            ...
            abortRequest: function(t) {
                var e;
                this.pending[t.name] && (e = this.elementAjaxPort(t),
                u.ajaxAbort(e),
                this.pendingRequest--,
                this.pendingRequest < 0 && (this.pendingRequest = 0),
                delete this.pending[t.name],
        ...
        normalizeAttributeRule: function(t, e, i, n) {
            (n = /min|max|step/.test(i) && (null === e || /number|range|text/.test(e)) && (n = Number(n),
            isNaN(n)) ? void 0 : n) || 0 === n ? t[i] = n : e === i && "range" !== e && (t["date" === e ? "dateISO" : i] = !0)
        },
        attributeRules: function(t) {
            var e, i, n = {}, o = u(t), r = t.getAttribute("type");
        ...
        methods: {
            ...
            step: function(t, e, i) {
                ...
                var r, s = u(e).attr("type"), a = "Step attribute on input type " + s + " is not supported.", l = new RegExp("\\b" + s + "\\b"), c = !0;
            ...
            remote: function(n, o, t, r) {
                ...
                var s, e, a = this.previousValue(o, r);
                ...
                null !== a.valid && a.old === e ? a.valid : (a.old = e,
                a.valid = null,
    ...
    return u.ajaxPrefilter ? u.ajaxPrefilter(function(t, e, i) {
        var n = t.port;
        "abort" === t.mode && (u.ajaxAbort(n),
        o[n] = i)
    }) : (n = u.ajax,
    u.ajax = function(t) {
        var e = ("mode"in t ? t : u.ajaxSettings).mode
          , t = ("port"in t ? t : u.ajaxSettings).port;
        return "abort" === e ? (u.ajaxAbort(t),
        o[t] = n.apply(this, arguments),
        o[t]) : n.apply(this, arguments)
    }
    ),
    ...
    n.fn.appear = function(i, t) {
        ...
        return this.each(function() {
            ...
            e = function() {
                ...
                l = h.width(),
                c = u.width(),
                e <= n + s + r) && n <= e + a + r && t <= i + l + o && i <= t + c + o ? h.appeared || h.trigger("appear", d.data) : h.appeared = !1
            }
            ,
            t = function() {
                var t;
...
(t => {
    ...
    function s(t, s) {
        ...
        e.getContext("2d")), r = (e.width = e.height = s.size,
        1), a = (1 < window.devicePixelRatio && (r = window.devicePixelRatio,
        ...
        (s.size - s.lineWidth) / 2), l = (s.scaleColor && s.scaleLength && (a -= s.scaleLength + 2),
        ...
        function(t, e, i) {
            ...
            var t, e;
            o.lineWidth = 1,
            o.fillStyle = s.scaleColor,
            o.save();
            for (var i = 24; 0 < i; --i)
                t = i % 6 == 0 ? (e = s.scaleLength,
                0) : (e = .6 * s.scaleLength,
                s.scaleLength - e),
        ...
        this.draw = function(t) {
            var e;
            s.scaleColor || s.trackColor ? o.getImageData && o.putImageData ? n ? o.putImageData(n, 0, 0) : (i(),
            n = o.getImageData(0, 0, s.size * r, s.size * r)) : (this.clear(),
            i()) : this.clear(),
            o.lineCap = s.lineCap,
    ...
    function i(l, c, u) {
        ...
        u.fn[l] = function(t) {
            ...
            (e = this).each(function(t, e) {
                ...
                r = void 0 === r ? i : r) : d(s + " is not a valid method") : d(l + " not initialized. Cannot call methods, i.e. " + s)
            }),
            void 0 !== r ? r : e) : (a = t,
...
( (t, e) => {
    ...
    function y(t) {
        ...
        (t = "string" == typeof t ? document.querySelector(t) : t) && "object" == typeof t && t.nodeType) {
            ...
            for (var r = o.isBorderBox = "border-box" == e.boxSizing, s = 0; s < w; s++) {
                var a = _[s]
                  , l = e[a]
                  , l = parseFloat(l);
                o[a] = isNaN(l) ? 0 : l
...
( (t, e) => {
    ...
    t.layoutPosition = function() {
        var t = this.layout.size
          ...
          , i = (e[i ? "left" : "right"] = this.getXValue(r),
        e[o] = "",
...
( (t, e) => {
    ...
    e._getItemLayoutPosition = function(t) {
        ...
        for (var e = t.size.outerWidth % this.columnWidth, e = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), e = Math.min(e, this.cols), i = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](e, t), n = {
            ...
            y: i.y
        }, o = i.y + t.size.outerHeight, r = e + i.col, s = i.col; s < r; s++)
            this.colYs[s] = o;
        return n
    }
    ,
    ...
    e._manageStamp = function(t) {
        ...
        for (var o = Math.min(this.cols - 1, o), r = (this._getOption("originTop") ? t.top : t.bottom) + e.outerHeight, s = i; s <= o; s++)
...
( (s, a) => {
    ...
    function(t) {
        ...
        ,
        (o = c.sortDataParsers[t[1]]) ? function(t) {
            return t && o(n(t))
        }
        : function(t) {
            return t && n(t)
...
( (t, e) => {
    ...
    return t.contains = function(t) {
        var e = t.width || 0;
        return this.x <= t.x && this.y <= t.y && this.x + this.width >= t.x + e && this.y + this.height >= t.y + (t.height || 0)
    }
    ,
...
( (t, e) => {
    ...
    i._applyGridGutter = function(t, e) {
        var i;
        return e ? (i = t % (e += this.gutter),
        Math[i && i < 1 ? "round" : "ceil"](t / e) * e) : t + this.gutter
    }
    ,
    ...
    i.resizeShiftPercentLayout = function() {
        var i, e, n, t = this._getItemsForLayout(this.items), o = this._getOption("horizontal"), r = o ? "y" : "x", s = o ? "height" : "width", a = o ? "rowHeight" : "columnWidth", o = o ? "innerHeight" : "innerWidth", l = this[a];
    ...
    i.updateShiftTargets = function(t) {
        ...
        if (u = u && u + this.gutter)
            for (var e = Math.ceil(t.rect[c] / u), o = Math.floor((this.shiftPacker[c] + this.gutter) / u), h = (o - e) * u, r = 0; r < o; r++)
    ...
    i.itemDragMove = function(t, e, i) {
        ...
        var o, r = this.isEnabled && this.getItem(t);
        r && (e -= this.size.paddingLeft,
...
( (l, i, n, a) => {
    ...
    c.Workers = [{
        ...
        filter: ["width", "items", "settings"],
        run: function(t) {
            var e, i = (this.width() / this.settings.items).toFixed(3) - this.settings.margin, n = this._items.length, o = !this.settings.autoWidth, r = [];
            for (t.items = {
                merge: !1,
                width: i
            }; n--; )
    ...
    c.prototype.closest = function(i, n) {
        ...
        return this.settings.freeDrag || l.each(s, l.proxy(function(t, e) {
            return "left" === n && e - 30 < i && i < e + 30 ? o = t : "right" === n && e - r - 30 < i && i < e - r + 30 ? o = t + 1 : this.op(i, "<", e) && this.op(i, ">", s[t + 1] !== a ? s[t + 1] : e - r) && (o = "left" === n ? t + 1 : t),
            -1 === o
        }, this)),
    ...
    c.prototype.to = function(t, e) {
        ...
        (o = (((t = i + n) - s) % r + r) % r + s) !== t && o - n <= a && 0 < o - n && this.reset(i = (t = o) - n)) : t = this.settings.rewind ? (t % (a += 1) + a) % a : Math.max(s, Math.min(a, t)),
...
( (u, e) => {
    ...
    i.prototype.fetch = function(t, e) {
        ...
        if (-1 < (n = s.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com|be\-nocookie\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu"))
            i = "youtube";
    ...
    i.prototype.thumbnail = function(e, t) {
        ...
        var n, o, r = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", s = e.find("img"), a = "src", l = "", c = this._core.settings;
        if (e.wrap(u("<div/>", {
...
(s => {
    ...
    e.prototype.swap = function() {
        var t, e, i, n, o, r;
        1 === this.core.settings.items && s.support.animation && s.support.transition && (this.core.speed(0),
        ...
        o) && n.one(s.support.animation.end, e).addClass("animated owl-animated-in").addClass(o)
    }
    ,
...
(t => {
    ...
    function d(t, e) {
        ...
        f.st.callbacks[t]) && f.st.callbacks[t].apply(f, Array.isArray(e) ? e : [e])
    }
    function p(t) {
        return t === i && f.currTemplate.closeBtn || (f.currTemplate.closeBtn = c(f.st.closeMarkup.replace("%title%", f.st.tClose)),
        i = t),
    ...
    var f, n, m, a, g, i, l, v, y, b, _, w = "Close", x = "BeforeClose", C = "MarkupParse", T = ".mfp", E = "mfp-ready", z = "mfp-removing", S = "mfp-prevent-close", k = !!window.jQuery, I = c(window), A = (c.magnificPopup = {
        instance: null,
        proto: t.prototype = {
            constructor: t,
            init: function() {
            ...
            open: function(t) {
                ...
                if (!f.isOpen) {
                    ...
                    d("BeforeOpen"),
                    f.st.showCloseBtn && (f.st.closeBtnInside ? (u(C, function(t, e, i, n) {
                    ...
                    var s = f.wH = I.height()
                      , a = {}
                      , l = (f.fixedContentPos && f._hasScrollBar(s) && (l = f._getScrollbarSize()) && (a.marginRight = l),
                    ...
                    setTimeout(function() {
                        f.content ? (f._addClassToMFP(E),
                        f._setFocus()) : f.bgOverlay.addClass(E),
            ...
            close: function() {
                f.isOpen && (d(x),
                f.isOpen = !1,
                f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(z),
                setTimeout(function() {
                    f._close()
            ...
            updateItemHTML: function() {
                ...
                f.currItem = t,
                f.currTemplate[e] || (d("FirstMarkupParse", i = !!f.st[e] && f.st[e].markup),
                f.currTemplate[e] = !i || c(i)),
                a && a !== t.type && f.container.removeClass("mfp-" + a + "-holder"),
            ...
            _checkIfClose: function(t) {
                if (!c(t).closest("." + S).length) {
                    ...
                    if (e && i)
                        return !0;
                    if (!f.content || c(t).closest(".mfp-close").length || f.preloader && t === f.preloader[0])
                        return !0;
            ...
            _hasScrollBar: function(t) {
                return (f.isIE7 ? m.height() : document.body.scrollHeight) > (t || I.height())
            },
            _setFocus: function() {
            ...
            _parseMarkup: function(o, t, e) {
                ...
                c.each(t, function(t, e) {
                    if (void 0 === e || !1 === e)
                        return !0;
                    var i, n;
                    1 < (r = t.split("_")).length ? 0 < (i = o.find(".mfp-" + r[0])).length && ("replaceWith" === (n = r[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === n ? i.is("img") ? i.attr("src", e) : i.replaceWith(c("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(r[1], e)) : f.st.allowHTMLInTemplate ? o.find(".mfp-" + t).html(e) : o.find(".mfp-" + t).text(e)
                })
            },
    ...
    c.fn.magnificPopup = function(t) {
        r();
        var e, i, n, o = c(this);
        return "string" == typeof t ? "open" === t ? (e = k ? o.data("magnificPopup") : o[0].magnificPopup,
    ...
    ,
    "inline"), O = (c.magnificPopup.registerModule(A, {
        options: {
            hiddenClass: "hide",
            markup: "",
        ...
        proto: {
            ...
            getInline: function(t, e) {
                ...
                return s(),
                t.src ? (i = f.st.inline,
                (n = c(t.src)).length ? ((o = n[0].parentNode) && o.tagName && (v || (l = i.hiddenClass,
                v = h(l),
                l = "mfp-" + l),
    ...
    function L(t) {
        var e;
        f.currTemplate[j] && (e = f.currTemplate[j].find("iframe")).length && (t || (e[0].src = "//about:blank"),
            ...
            findImageSize: function(i) {
                ...
                !function t(e) {
                    ...
                    _ = setInterval(function() {
                        0 < o.naturalWidth ? f._onImageHasSize(i) : (200 < n && clearInterval(_),
                        3 == ++n ? t(10) : 40 === n ? t(50) : 100 === n && t(500))
                    }, e)
                }(1)
            },
    ...
    c.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                s.enabled && f.supportsTransition && (e = s.duration,
                i = function(t) {
                ...
                u("BuildControls.zoom", function() {
                    f._allowZoom() && (clearTimeout(o),
                    f.content.css("visibility", "hidden"),
                    (t = f._getItemToZoom()) ? ((r = i(t)).css(f._getOffset()),
                    f.wrap.append(r),
            ...
            _getOffset: function(t) {
                ...
                return (P = void 0 === P ? void 0 !== document.createElement("p").style.MozTransform : P) ? t["-moz-transform"] = t.transform = "translate(" + e.left + "px," + e.top + "px)" : (t.left = e.left,
                t.top = e.top),
                t
            }
        }
    });
    var P, j = "iframe", M = (c.magnificPopup.registerModule(j, {
        options: {
        ...
        proto: {
            initGallery: function() {
                ...
                u("BuildControls" + t, function() {
                    var t, e, i, n, o;
                    1 < f.items.length && r.arrows && !f.arrowLeft && (e = "rtl" === r.langDir ? (n = r.tNext,
                    t = r.tPrev,
                    o = "next",
                    "prev") : (n = r.tPrev,
                    t = r.tNext,
                    ...
                    "next"),
                    i = r.arrowMarkup,
                    n = f.arrowLeft = c(i.replace(/%title%/gi, n).replace(/%action%/gi, o).replace(/%dir%/gi, "left")).addClass(S),
                    o = f.arrowRight = c(i.replace(/%title%/gi, t).replace(/%action%/gi, e).replace(/%dir%/gi, "right")).addClass(S),
                    "rtl" === r.langDir ? (f.arrowNext = n,
                    f.arrowPrev = o) : (f.arrowNext = o,
                    f.arrowPrev = n),
                    n.on("click", function() {
            ...
            _preloadItem: function(t) {
                var e;
                t = D(t),
                f.items[t].preloaded || (d("LazyLoad", e = (e = f.items[t]).parsed ? e : f.parseEl(t)),
            ...
            updateGalleryButtons: function() {
                f.st.gallery.loop || "object" != typeof f.arrowPrev || null === f.arrowPrev || (0 === f.index ? f.arrowPrev.hide() : f.arrowPrev.show(),
                f.index === f.items.length - 1 ? f.arrowNext.hide() : f.arrowNext.show())
            }
        }
    }),
    "retina");
...
( () => {
    ...
    e.prototype.lineToPath = function(t) {
        var e = {}
          , i = t.x1 || 0;
        return e.d = "M" + i + "," + (t.y1 || 0) + "L" + (t.x2 || 0) + "," + (t.y2 || 0),
        e
    }
    ,
    e.prototype.rectToPath = function(t) {
        var e, i = {}, n = parseFloat(t.x) || 0, o = parseFloat(t.y) || 0, r = parseFloat(t.width) || 0, s = parseFloat(t.height) || 0;
        ...
        i.d = "M " + (n + e) + "," + o + " L " + (n + r - e) + "," + o + " A " + e + "," + t + ",0,0,1," + (n + r) + "," + (o + t) + " L " + (n + r) + "," + (o + s - t) + " A " + e + "," + t + ",0,0,1," + (n + r - e) + "," + (o + s) + " L " + (n + e) + "," + (o + s) + " A " + e + "," + t + ",0,0,1," + n + "," + (o + s - t) + " L " + n + "," + (o + t) + " A " + e + "," + t + ",0,0,1," + (n + e) + "," + o) : i.d = "M" + n + " " + o + " L" + (n + r) + " " + o + " L" + (n + r) + " " + (o + s) + " L" + n + " " + (o + s) + " Z",
        i
    }
    ,
    ...
    e.prototype.ellipseToPath = function(t) {
        ...
        return e.d = "M" + r + "," + s + "A" + i + "," + n + " 0,1,1 " + o + "," + t + "A" + i + "," + n + " 0,1,1 " + r + "," + t,
        e
    }
    ,
    e.prototype.circleToPath = function(t) {
        ...
        return e.d = "M" + o + "," + r + "A" + i + "," + i + " 0,1,1 " + n + "," + t + "A" + i + "," + i + " 0,1,1 " + o + "," + t,
        e
    }
    ,
    ...
    e.prototype.parseAttr = function(t) {
        for (var e, i = {}, n = 0; n < t.length; n++) {
            if (-1 !== this.ATTR_WATCH.indexOf((e = t[n]).name) && -1 !== e.value.indexOf("%"))
    ...
    o.prototype.mapping = function() {
        var t, e, i, n, o = i = n = 0, r = this.el.querySelectorAll("path");
        for (l = !1,
        t = 0; t < r.length; t++) {
            var s, a, l, c, u = r[t];
...
( () => {
    ...
    function _(t) {
        var e = t.parentNode;
        return 9 == t.nodeType && t != m ? r(t) : (e = e && e.assignedSlot ? e.assignedSlot.parentNode : e) && 11 == e.nodeType && e.host ? e.host : e
    }
    function l(t) {
    ...
    t.prototype._monitorIntersections = function(e) {
        ...
        o = n = null,
        this.POLL_INTERVAL ? n = t.setInterval(i, this.POLL_INTERVAL) : (s(t, "resize", i, !0),
        s(e, "scroll", i, !0),
        ...
        e != t) && (t = r(e)) && this._monitorIntersections(t.ownerDocument)
    }
    ,
    t.prototype._unmonitorIntersections = function(n) {
        ...
        t(),
        n != o && (e = r(n)) && this._unmonitorIntersections(e.ownerDocument)))
    }
    ,
    ...
    t.prototype._checkForIntersections = function() {
        ...
        this._observationTargets.forEach(function(t) {
            var e = t.element
              ...
              , s = null
              , t = (this._rootContainsTarget(e) ? g && !this.root || (s = l) : s = {
                top: 0,
                bottom: 0,
                left: 0,
                right: 0,
    ...
    t.prototype._computeTargetAndRootIntersection = function(t, e, i) {
        if ("none" != window.getComputedStyle(t).display) {
            for (var n, o, r, s, a = e, l = _(t), c = !1; !c && l; ) {
                ...
                s = p - f,
                a = 0 <= (r = (o = Math.min(u.right, h.right)) - n) && 0 <= s ? {
                    top: f,
                    bottom: p,
                    left: n,
                    right: o,
    ...
    d.fn.pin = function(l) {
        ...
        function() {
            for (var t = 0, e = c.length; t < e; t++) {
                ...
                o = i.offset(),
                r = a.parent().offset(),
                s = (a.parent().is(".pin-wrapper") || a.wrap("<div class='pin-wrapper'>"),
                d.extend({
                    top: 0,
                    bottom: 0
                }, l.padding || {})),
          ...
          , t = function() {
            if (!u) {
                ...
                for (var t = [], e = 0, i = c.length; e < i; e++) {
                    var n, o, r = d(c[e]), s = r.data("pin");
                    s && (t.push(r),
                    n = s.from - s.pad.bottom,
                    o = s.to - s.pad.top,
                    n + r.outerHeight() > s.end ? r.css("position", "") : n < a && a < o ? ("fixed" != r.css("position") && r.css({
                        left: r.offset().left,
                        top: s.pad.top
                    }).css("position", "fixed"),
                    l.activeClass && r.addClass(l.activeClass)) : o <= a ? (r.css({
                        left: "",
                        top: o - s.parentTop + s.pad.top
                    }).css("position", "absolute"),
                    l.activeClass && r.addClass(l.activeClass)) : (r.css({
                        position: "",
                        top: "",
                        left: ""
                    }),
...
jQuery(document).ready(function(s) {
    ...
    function f(t) {
        ...
        function t(e, i, n, o) {
            ...
            {
                var r;
                e.is(":last-child") && s("html").hasClass("no-csstransitions") && (r = v(i),
                y(i, r))
            }
        }(t.find("i").eq(0), t, i, o),
    ...
    theme.fn.intObs(t, function() {
        s(this).hasClass("letters") && s(this).find("b").each(function() {
            var t = s(this)
              , e = t.text().split("")
...
( (r, e) => {
    ...
    r.HoverDir.prototype = {
        ...
        _applyAnimation: function(t, e, i) {
            ...
            t.stop().applyStyle(e, r.extend(!0, [], {
                duration: i + "ms"
            }))
        }
    },
    r.fn.hoverdir = function(t) {
        var e, i = r.data(this, "hoverdir");
        return "string" == typeof t ? (e = Array.prototype.slice.call(arguments, 1),
        this.each(function() {
            i ? r.isFunction(i[t]) && "_" !== t.charAt(0) ? i[t].apply(i, e) : n("no such method '" + t + "' for hoverdir instance") : n("cannot call methods on hoverdir prior to initialization; attempted to call method '" + t + "'")
        })) : this.each(function() {
...
( (t, e) => {
    ...
    var n = "vide"
      ...
      , f = "Not implemented";
    function r(t) {
        for (var e, i, n, o, r = {}, s = t.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(","), a = 0, l = s.length; a < l && -1 === (i = s[a]).search(/^(http|https|ftp):\/\//) && -1 !== i.search(":"); a++)
            e = i.indexOf(":"),
            n = i.substring(0, e),
    ...
    s.prototype.init = function() {
        var t, e, i, n, o = this, r = o.path, s = r, a = "", l = o.$element, c = o.settings, u = (t => {
            for (var e, i = (t = "" + t).split(/\s+/), n = "50%", o = "50%", r = 0, s = i.length; r < s; r++)
                "left" === (e = i[r]) ? n = "0%" : "right" === e ? n = "100%" : "top" === e ? o = "0%" : "bottom" === e ? o = "100%" : "center" === e ? 0 === r ? n = "50%" : o = "50%" : 0 === r ? n = e : o = e;
            return {
                x: n,
                y: o
            }
        ...
        p('<img src="' + i + '.png">').on("load", d)) : "none" !== h && e.css("background-image", "url(" + s + "." + h + ")"),
        "static" === l.css("position") && l.css("position", "relative"),
        l.prepend(e),
        t = "object" == typeof r ? (r.mp4 && (a += '<source src="' + r.mp4 + '.mp4" type="video/mp4">'),
        r.webm && (a += '<source src="' + r.webm + '.webm" type="video/webm">'),
        r.ogv && (a += '<source src="' + r.ogv + '.ogv" type="video/ogg">'),
        o.$video = p("<video>" + a + "</video>")) : o.$video = p('<video><source src="' + r + '.mp4" type="video/mp4"><source src="' + r + '.webm" type="video/webm"><source src="' + r + '.ogv" type="video/ogg"></video>');
        try {
            t.prop({
                autoplay: c.autoplay,
                loop: c.loop,
...
(t => {
    ...
    function n(z, l) {
        function t(t) {
            if (!(!0 === k.data(Dt + "_intouch") || 0 < at(t.target).closest(l.excludedElements, k).length)) {
                var e, i, n, o = t.originalEvent || t;
                if (!o.pointerType || "mouse" != o.pointerType || 0 != l.fallbackToMouseEvents)
                    return n = (i = o.touches) ? i[0] : o,
                    I = Et,
                    i ? A = i.length : !1 !== l.preventDefaultEvents && t.preventDefault(),
                    E = b = y = null,
                    C = 1,
                    T = x = w = _ = v = 0,
                    (t = {})[lt] = a(lt),
                    ...
                    Z(),
                    d(0, n),
                    !i || A === l.fingers || l.fingers === Ct || u() ? (rt = p(),
                    2 == A && (d(1, i[1]),
                    w = x = et(O[0].start, O[1].start)),
                    (l.swipeStatus || l.pinchStatus) && (e = c(o, I))) : e = !1,
                    !1 === e ? (c(o, I = It),
                    e) : (l.hold && (M = setTimeout(at.proxy(function() {
        ...
        function e(t) {
            ...
            if (I !== kt && I !== It && !h()) {
                var i, n = e.touches, o = K(n ? n[0] : e);
                if (L = p(),
                n && (A = n.length),
                l.hold && clearTimeout(M),
                I = St,
                2 == A && (0 == w ? (d(1, n[1]),
                w = x = et(O[0].start, O[1].start)) : (K(n[1]),
                ...
                C = (x / w * 1).toFixed(2),
                T = Math.abs(w - x)),
                A === l.fingers || l.fingers === Ct || !n || u()) {
                    y = it(o.start, o.end),
                    b = it(o.last, o.end);
                    var r, s = t, n = b;
                    if (!1 !== l.preventDefaultEvents)
                        if (l.allowPageScroll === ft)
                            s.preventDefault();
                        else {
                            var a = l.allowPageScroll === mt;
                            switch (n) {
                            case lt:
                                (l.swipeLeft && a || !a && l.allowPageScroll != wt) && s.preventDefault();
                                break;
                            case ct:
                                (l.swipeRight && a || !a && l.allowPageScroll != wt) && s.preventDefault();
                                break;
                            case ut:
                                (l.swipeUp && a || !a && l.allowPageScroll != xt) && s.preventDefault();
                                break;
                            case ht:
                                (l.swipeDown && a || !a && l.allowPageScroll != xt) && s.preventDefault()
                            }
                        }
                    t = o.start,
                    n = o.end,
                    v = Math.round(Math.sqrt(Math.pow(n.x - t.x, 2) + Math.pow(n.y - t.y, 2))),
                    _ = tt(),
                    n = v,
                    (t = y) != ft && (n = Math.max(n, J(t)),
                    S[t].distance = n),
                    i = c(e, I),
                    l.triggerOnTouchEnd && !l.triggerOnTouchLeave || (t = !0,
                    l.triggerOnTouchLeave && (r = {
                    ...
                    n = o.end,
                    o = r,
                    t = n.x > o.left && n.x < o.right && n.y > o.top && n.y < o.bottom),
                    !l.triggerOnTouchEnd && t ? I = q(St) : l.triggerOnTouchLeave && !t && (I = q(kt)),
                    I != It && I != kt) || c(e, I)
                } else
                    c(e, I = It);
                !1 === i && c(e, I = It)
        ...
        function i(t) {
            ...
            L = p(),
            _ = tt(),
            F() || !H() ? c(i, I = It) : l.triggerOnTouchEnd || !1 === l.triggerOnTouchEnd && I === St ? (!1 !== l.preventDefaultEvents && !1 !== t.cancelable && t.preventDefault(),
            c(i, I = kt)) : !l.triggerOnTouchEnd && Y() ? r(i, I = kt, yt) : I === St && c(i, I = It),
            s(!1),
            null
        }
        function o() {
        ...
        function R(t) {
            t = t.originalEvent || t;
            l.triggerOnTouchLeave && c(t, I = q(kt))
        }
        function N() {
            k.off(f, t),
            k.off(g, o),
        ...
        function q(t) {
            var e = t
              ...
              , n = H()
              , o = F();
            return !i || o ? e = It : !n || t != St || l.triggerOnTouchEnd && !l.triggerOnTouchLeave ? !n && t == kt && l.triggerOnTouchLeave && (e = It) : e = kt,
            e
        }
        function c(t, e) {
            var i, n = t.touches;
            return (B() && V() || V()) && (i = r(t, e, gt)),
            ($() && u() || u()) && !1 !== i && (i = r(t, e, vt)),
            G() && X() && !1 !== i ? i = r(t, e, bt) : _ > l.longTapThreshold && v < Tt && l.longTap && !1 !== i ? i = r(t, e, _t) : 1 !== A && At || !(isNaN(v) || v < l.threshold) || !Y() || !1 === i || (i = r(t, e, yt)),
            e === It && o(),
            e !== kt || n && n.length || o(),
            i
        }
        function r(t, e, i) {
            var n;
            if (i == gt) {
                if (k.trigger("swipeStatus", [e, y || null, v || 0, _ || 0, A, O, b]),
                l.swipeStatus && !1 === (n = l.swipeStatus.call(k, t, e, y || null, v || 0, _ || 0, A, O, b)))
                    return !1;
                if (e == kt && B()) {
                    if (clearTimeout(j),
                    clearTimeout(M),
                    k.trigger("swipe", [y, v, _, A, O, b]),
                    l.swipe && !1 === (n = l.swipe.call(k, t, y, v, _, A, O, b)))
                        return !1;
                    switch (y) {
                    case lt:
                        k.trigger("swipeLeft", [y, v, _, A, O, b]),
                        l.swipeLeft && (n = l.swipeLeft.call(k, t, y, v, _, A, O, b));
                        break;
                    case ct:
                        k.trigger("swipeRight", [y, v, _, A, O, b]),
                        l.swipeRight && (n = l.swipeRight.call(k, t, y, v, _, A, O, b));
                        break;
                    case ut:
                        k.trigger("swipeUp", [y, v, _, A, O, b]),
                        l.swipeUp && (n = l.swipeUp.call(k, t, y, v, _, A, O, b));
                        break;
                    case ht:
                        k.trigger("swipeDown", [y, v, _, A, O, b]),
                        l.swipeDown && (n = l.swipeDown.call(k, t, y, v, _, A, O, b))
                    }
                }
            }
            if (i == vt) {
                if (k.trigger("pinchStatus", [e, E || null, T || 0, _ || 0, A, C, O]),
                l.pinchStatus && !1 === (n = l.pinchStatus.call(k, t, e, E || null, T || 0, _ || 0, A, C, O)))
                    return !1;
                if (e == kt && $())
                    switch (E) {
                    case dt:
                        k.trigger("pinchIn", [E || null, T || 0, _ || 0, A, C, O]),
                        l.pinchIn && (n = l.pinchIn.call(k, t, E || null, T || 0, _ || 0, A, C, O));
                        break;
                    case pt:
                        k.trigger("pinchOut", [E || null, T || 0, _ || 0, A, C, O]),
                        l.pinchOut && (n = l.pinchOut.call(k, t, E || null, T || 0, _ || 0, A, C, O))
                    }
            }
            return i == yt ? e !== It && e !== kt || (clearTimeout(j),
            clearTimeout(M),
            X() && !G() ? (P = p(),
            j = setTimeout(at.proxy(function() {
                P = null,
                k.trigger("tap", [t.target]),
                l.tap && (n = l.tap.call(k, t, t.target))
            }, this), l.doubleTapThreshold)) : (P = null,
            k.trigger("tap", [t.target]),
            l.tap && (n = l.tap.call(k, t, t.target)))) : i == bt ? e !== It && e !== kt || (clearTimeout(j),
            clearTimeout(M),
            P = null,
            k.trigger("doubletap", [t.target]),
            l.doubleTap && (n = l.doubleTap.call(k, t, t.target))) : i != _t || e !== It && e !== kt || (clearTimeout(j),
            P = null,
        ...
        function F() {
            var t = !1;
            return t = null !== l.cancelThreshold && null !== y ? J(y) - v >= l.cancelThreshold : t
        }
        function W() {
        ...
        function U() {
            return A === l.fingers || l.fingers === Ct || !At
        }
        function Q() {
            return 0 !== O[0].end.x
        }
        ...
        function h() {
            var t = !1;
            return t = D && p() - D <= l.fingerReleaseThreshold ? !0 : t
        }
        function s(t) {
            k && (!0 === t ? (k.on(nt, e),
            k.on(ot, i),
            m && k.on(m, R)) : (k.off(nt, e, !1),
            k.off(ot, i, !1),
            m && k.off(m, R, !1)),
        ...
        function K(t) {
            var e = void 0 !== t.identifier ? t.identifier : 0
              , i = O[e] || null;
            return (i = null === i ? d(e, t) : i).last.x = i.end.x,
            i.last.y = i.end.y,
        ...
        function it(t, e) {
            var i, n;
            return i = e,
            (n = t).x == i.x && n.y == i.y ? ft : (n = e,
            t = (i = t).x - e.x,
            n = Math.atan2(e.y - i.y, t),
            i = (i = Math.round(180 * n / Math.PI)) < 0 ? 360 - Math.abs(i) : i,
            i <= 45 && 0 <= i || i <= 360 && 315 <= i ? lt : 135 <= i && i <= 225 ? ct : 45 < i && i < 135 ? ht : ut)
        }
        function p() {
            return (new Date).getTime()
        }
        var l = at.extend({}, l)
          , n = At || Lt || !l.fallbackToMouseEvents
          , f = n ? Lt ? Ot ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown"
          , nt = n ? Lt ? Ot ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove"
          , ot = n ? Lt ? Ot ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup"
    ...
    var lt = "left"
      ...
      , Ot = window.navigator.msPointerEnabled && !window.PointerEvent && !At
      , Lt = (window.PointerEvent || window.navigator.msPointerEnabled) && !At
      , Dt = "TouchSwipe";
...
(p => {
    p.fn.visible = function(t, e, i, n) {
        ...
        if (!(this.length < 1))
            ...
            s = t ? s || a : s && a,
            a = t ? o || r : o && r,
            "both" === i ? e && s && a : "vertical" === i ? e && s : "horizontal" === i ? e && a : void 0) : (r = (o = c ? 0 : h) + d,
            a = (s = n.scrollLeft()) + l,
...
(t => {
    ...
    function c(t) {
        ...
        return "object" == typeof t ? s.extend(e, t) : ("boolean" == typeof t ? e.byRow = t : "remove" === t && (e.remove = !0),
        e)
    }
    function n(t) {
...
(t => {
    ...
    d.fn.waitForImages = function() {
        var o, r, e, s = 0, a = 0, l = d.Deferred(), c = this, u = [], i = d.waitForImages.hasImageProperties || [], n = d.waitForImages.hasImageAttributes || [], h = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
...
(h => {
    fontSpy = function(t, e) {
        ...
        var t = {
          ...
          , a = h.extend(t, e)
          , l = h("<span>" + a.testString + a.glyphs + "</span>").css("position", "absolute").css("top", "-9999px").css("left", "-9999px").css("visibility", "hidden").css("fontFamily", a.testFont).css("fontSize", "250px")
          , c = (n.append(l),
        l.outerWidth())
          , u = (l.css("fontFamily", a.font + "," + a.testFont),
        function() {
            var t = l.outerWidth();
...
( (t, e) => {
    ...
    function o(n, o, r, t) {
        ...
        var s, e, t = Object.assign({}, {
            ...
            modLeft: "0px",
            threshold: [0]
        }, t), i = t.viewport, a = t.modTop, l = t.modLeft, c = t.modBottom, u = t.modRight, t = t.threshold;
        if (Array.isArray(t) || "number" == typeof t)
            ...
            (e = new IntersectionObserver(function(t, e) {
                ...
                t && (t.isInViewport = t.isIntersecting && t.intersectionRatio >= s,
...
(t => {
    ...
    O.fn.marquee = function(A) {
        return this.each(function() {
            var i, n, o, r, s, a = O.extend({}, O.fn.marquee.defaults, A), l = O(this), c = 3, t = "animation-play-state", u = !1, h = function(t, e, i) {
                ...
                l.timer = setTimeout(I, a.delayBeforeStart)
            }, e = {
                pause: function() {
            ...
            if ("string" == typeof A)
                O.isFunction(e[A]) && (i = i || l.find(".js-marquee-wrapper"),
                ...
                if (a.duplicated) {
                    a.duplicateCount <= 0 && (a.duplicateCount = 1);
                    for (let t = 0; t < a.duplicateCount; t++)
                        v.clone(!0).appendTo(l)
                }
                if (l.wrapInner('<div style="width:100000px" class="js-marquee-wrapper"></div>'),
                ...
                a.duration = parseInt(g, 10) / parseInt(m, 10) * a.duration) : a.duration = (parseInt(g, 10) + parseInt(m, 10)) / parseInt(m, 10) * a.duration) : (s = l.find(".js-marquee:first").width() + a.gap,
                n = l.width(),
                a.startVisible && !a.duplicated ? (a._completeDuration = (parseInt(s, 10) + parseInt(n, 10)) / parseInt(n, 10) * a.duration,
                a.duration = parseInt(s, 10) / parseInt(n, 10) * a.duration) : a.duration = (parseInt(s, 10) + parseInt(n, 10)) / parseInt(n, 10) * a.duration),
                ...
                var S = function() {
                  ...
                  , k = function() {
                    i.css("transform", "translateX(" + ("left" === a.direction ? n + "px" : "-" + s + "px") + ")")
                }
                  , I = (a.duplicated ? (r ? a.startVisible ? i.css("transform", "translateY(0)") : i.css("transform", "translateY(" + ("up" === a.direction ? m + "px" : "-" + (2 * g - a.gap) + "px") + ")") : a.startVisible ? i.css("transform", "translateX(0)") : i.css("transform", "translateX(" + ("left" === a.direction ? n + "px" : "-" + (2 * s - a.gap) + "px") + ")"),
                a.startVisible || (c = 1)) : a.startVisible ? c = 2 : (r ? S : k)(),
                function() {
                    var t, e;
                    a.duplicated && (1 === c ? (a._originalDuration = a.duration,
                    a.duration = r ? "up" === a.direction ? a.duration + m / (g / a.duration) : 2 * a.duration : "left" === a.direction ? a.duration + n / (s / a.duration) : 2 * a.duration,
                    ...
                    c++)),
                    r ? a.duplicated ? (2 < c && i.css("transform", "translateY(" + ("up" === a.direction ? 0 : "-" + g + "px") + ")"),
                    o = {
                    ...
                    }) : a.duplicated ? (2 < c && i.css("transform", "translateX(" + ("left" === a.direction ? 0 : "-" + s + "px") + ")"),
                    o = {
                        transform: "translateX(" + ("left" === a.direction ? "-" + s + "px" : 0) + ")"
                    }) : a.startVisible ? 2 === c ? (x = x && b + " " + a.duration / 1e3 + "s " + a.delayBeforeStart / 1e3 + "s " + a.css3easing,
                    o = {
                        transform: "translateX(" + ("left" === a.direction ? "-" + s + "px" : n + "px") + ")"
                    },
                    c++) : 3 === c && (a.duration = a._completeDuration,
                    x && (b += "0",
                    C = O.trim(C) + "0 ",
